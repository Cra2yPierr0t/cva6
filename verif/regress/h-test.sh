...
make -C ../.. clean
make clean_all
python3 cva6.py --c_tests ../tests/custom/h_extension/main.c --iss_yaml cva6.yaml --target cv64a6_mmu --iss=$DV_SIMULATORS --linker=../tests/custom/common/test.ld --gcc_opts="$CC_OPTS" $DV_OPTS
#make -C ../.. clean
#make clean_all
